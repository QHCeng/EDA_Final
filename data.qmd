...
In the graph below, -9 represents missing data in the dataset.
```{r}
library(ggplot2)
library(dplyr)
...
missing_summary <- colSums(is.na(tedsa_puf_2021_r)) / nrow(tedsa_puf_2021_r) * 100
